...
public class BanTimeChecker {
    ...
    public static boolean check(String player) throws IOException {
        ...
        hours1 = newString1[0];
        days1 = newString1[3];
        String until = band.getData().getString(player + ".tempban.czas");
        ...
        if (leftSide >= rightSide)
            return true;
        band.getData().set(player + ".tempban", null);
        band.saveData();
        return false;
    }
