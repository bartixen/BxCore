        ...
        if (sender.hasPermission("bxcore.commands.speed") || sender.isOp()) {
            if (args.length == 1) {
                ...
                if (liczba == 1) {
                    ...
                    p.sendMessage("§7Twoja predkość zostala ustawiona na §9" + liczba);
                } else {
                    if (liczba == 2) {
                                            ...
                                            if (liczba == 8) {
                                                ...
                                                if (liczba == 9) {
                                                    ...
                                                    if (liczba == 10) {
                                                        ...
                                                        sender.sendMessage("§7Podana liczba jest nieprawidlowa możesz podać od §91 §7do §910");
                                                    }
                                                }
                                            }
                                        }
                ...
                if (args.length == 2) {
                    ...
                    if (liczba == 1) {
                        ...
                        cel.sendMessage("§7Twoja predkość zostala ustawiona na §9" + liczba + " §7przez gracza §9" + sender.getName());
